...
def CarbonCopy(host, port, signee, signed):
    ...
    try:
        ...
        if (platform == "win32"):
            ...
            print(subprocess.check_output("signtool.exe sign /v /f " + PFXFILE + " /d \"MozDef Corp\" /tr \"http://sha1timestamp.ws.symantec.com/sha1/timestamp\" /fd SHA1 " + signed, shell=True).decode())
